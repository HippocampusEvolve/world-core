...
export class SmoothLook extends THREE.EventDispatcher {
    ...
    tPitch;
    _roll = 0;
    _kick = { x: 0, v: 0 }; // клевок приземления, рад (см. spring.ts)
    _accSm = 0; // сглаженное продольное ускорение тела
    _prevFwd = 0;
    _breathT = 0;
    ...
    update(dt, body) {
        ...
        const rollT = clamp(vYaw * c.turnRoll, -c.turnRollMax, c.turnRollMax) -
