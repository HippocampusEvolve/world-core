...
const PLATE = 0.012; // лист створки
const RIM = 0.03; // рамка под листом
...
const KNUCKLE = 0.008;
const OPEN = 1.75;
export function hatchLid({ w = 1.1, l = 2.4, mats } = {}) {
    ...
    for (const [side, s] of [
        ...
        for (const e of [-1, 1]) {
            ...
            rim.push(spanGeo(...sx(0.02 + BAR, inner - BAR), -PLATE - 0.024, -PLATE, e * (l / 6) - BAR / 2, e * (l / 6) + BAR / 2));
        }
