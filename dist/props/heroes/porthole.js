...
const SEG = 40;
export function porthole({ d = 1.3, mats } = {}) {
    ...
    g.add(part('porthole-rim', revolveGeo([
        [RB, BOT],
        [RS, BOT],
        [RS, -FL],
        [R, -FL],
    ...
    const WT = 0.014;
    const WY = 0.018;
    const parts = [cylGeo(HUB, HUB, 0.03, 16, 'y', 0, 0.015, 0), torusGeo(WR, WT, 8, 32, 'y', 0, WY, 0)];
    for (let i = 0; i < 4; i++) {
...
//# sourceMappingURL=porthole.js.map