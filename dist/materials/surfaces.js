...
export const SURFACE_MEAN_LINEAR = {
...
export function surfaceGenerator(kind, seed = 17) {
    return (x, y, size, p) => {
...
export const SURFACE_KINDS = ['snow', 'rock', 'gravel', 'concrete', 'wood', 'rust', 'metal', 'cloth', 'ice', 'paper'];
export const SURFACE_RECIPES = SURFACE_KINDS.map((kind, i) => ({
...
SURFACE_RECIPES.push(...SURFACE_KINDS.map((kind, i) => ({
