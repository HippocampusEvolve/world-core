...
export function calibratedSurface(kind, seed) {
    let cachedSize = 0;
    let color, height = new Float64Array(0), rough = new Float64Array(0), metal;
    const gen = (x, y, size, p) => {
        if (cachedSize !== size) {
