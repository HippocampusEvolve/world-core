...
function field(profile: Profile, n: number, seed: number, relief: boolean, cells: number) {
...
export function calibratedSurface(kind: keyof typeof SURFACE_PROFILES, seed: number): Generator {
  let cachedSize = 0
  let color: Float64Array | undefined, height = new Float64Array(0), rough = new Float64Array(0), metal: Float64Array | undefined
