...
export {
  ...
  type ChairOptions,
  type Chair,
  type ChairStackOptions,
  type ChairStack,
  type DeskOptions,
  type Desk,
  type NightstandOptions,
  type Nightstand,
  type SideboardOptions,
  type Sideboard,
...
export {
  ...
  type LockerOptions,
  type Locker,
  type MedCabinetOptions,
  type MedCabinet,
  type PanelBoxOptions,
  type PanelBox,
  type JerrycanOptions,
  type Jerrycan,
  type BucketOptions,
  type Bucket,
} from './storage.js'
export {
  ...
  photoFrame,
  nightLamp,
  type CoatBoardOptions,
  type CoatBoard,
  type CoveredMirrorOptions,
  type CoveredMirror,
  type ExtinguisherOptions,
  type Extinguisher,
  type CableTrayOptions,
  type CableTray,
  type WashbasinOptions,
  type Washbasin,
  type WallClockOptions,
  type WallClock,
  type PhotoFrameOptions,
  type PhotoFrame,
  type NightLampOptions,
  type NightLamp,
} from './fixtures.js'
export {
  bunk,
  ...
  type CotOptions,
  type Cot,
  type RolledMattressOptions,
  type RolledMattress,
  type FoldedCotOptions,
  type FoldedCot,
} from './beds.js'
export {
  plantRack,
  ...
  tagBox,
  scales,
  type PlantRackOptions,
  type PlantRack,
  type TomatoPlantOptions,
  type TomatoPlant,
  type JarOptions,
  type Jar,
...
export {
  ...
  type MugOptions,
  type Mug,
  type SugarBowlOptions,
  type SugarBowl,
  type CupShelfOptions,
  type CupShelf,
} from './tableware.js'
