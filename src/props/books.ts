...
export type Shelf = { group: THREE.Group; width: number; depth: number; height: number }

const COLORS = [0x6b3434, 0x35502f, 0x2f3f5c, 0x77582a, 0x4c3355]

export function shelfWithBooks({ width = 1.2, depth = 0.24, n = 5, colors = COLORS, mats }: ShelfOptions = {}): Shelf {
